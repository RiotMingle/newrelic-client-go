...
import (
	...
	"github.com/RiotMingle/newrelic-client-go/pkg/apiaccess"
	"github.com/RiotMingle/newrelic-client-go/pkg/apm"
	"github.com/RiotMingle/newrelic-client-go/pkg/cloud"
	"github.com/RiotMingle/newrelic-client-go/pkg/config"
	"github.com/RiotMingle/newrelic-client-go/pkg/dashboards"
	"github.com/RiotMingle/newrelic-client-go/pkg/edge"
	"github.com/RiotMingle/newrelic-client-go/pkg/entities"
	"github.com/RiotMingle/newrelic-client-go/pkg/events"
	"github.com/RiotMingle/newrelic-client-go/pkg/eventstometrics"
	"github.com/RiotMingle/newrelic-client-go/pkg/installevents"
	"github.com/RiotMingle/newrelic-client-go/pkg/logging"
	"github.com/RiotMingle/newrelic-client-go/pkg/logs"
	"github.com/RiotMingle/newrelic-client-go/pkg/nerdgraph"
	"github.com/RiotMingle/newrelic-client-go/pkg/nerdstorage"
	"github.com/RiotMingle/newrelic-client-go/pkg/notifications"
	"github.com/RiotMingle/newrelic-client-go/pkg/nrdb"
	"github.com/RiotMingle/newrelic-client-go/pkg/nrqldroprules"
	...
	"github.com/RiotMingle/newrelic-client-go/pkg/synthetics"
	"github.com/RiotMingle/newrelic-client-go/pkg/workflows"
