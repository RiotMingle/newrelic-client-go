...
[![Testing](https://github.com/RiotMingle/newrelic-client-go/workflows/Testing/badge.svg)](https://github.com/RiotMingle/newrelic-client-go/actions)
[![Security Scan](https://github.com/RiotMingle/newrelic-client-go/workflows/Security%20Scan/badge.svg)](https://github.com/RiotMingle/newrelic-client-go/actions)
[![Go Report Card](https://goreportcard.com/badge/github.com/RiotMingle/newrelic-client-go?style=flat-square)](https://goreportcard.com/report/github.com/RiotMingle/newrelic-client-go)
[![GoDoc](https://godoc.org/github.com/RiotMingle/newrelic-client-go?status.svg)](https://godoc.org/github.com/RiotMingle/newrelic-client-go)
[![License](https://img.shields.io/badge/License-Apache%202.0-blue.svg)](https://github.com/RiotMingle/newrelic-client-go/blob/main/LICENSE)
[![CLA assistant](https://cla-assistant.io/readme/badge/RiotMingle/newrelic-client-go)](https://cla-assistant.io/RiotMingle/newrelic-client-go)
[![Release](https://img.shields.io/github/release/RiotMingle/newrelic-client-go/all.svg)](https://github.com/RiotMingle/newrelic-client-go/releases/latest)
...
Follow the steps below to add `github.com/RiotMingle/newrelic-client-go` as a dependency in your Go project.

1. In the root directory of your project, run `go get github.com/RiotMingle/newrelic-client-go@latest`. This will update your `go.mod` file with the latest version `newrelic-client-go`.
...
2. Import `newrelic-client-go` in your project code.
    ...
    import "github.com/RiotMingle/newrelic-client-go/newrelic"
...
4. Your module's `go.mod` file should now be updated with the latest version of the client and should look similar to the following example (version number is hypothetical in the example below).
    ...
    require (
      github.com/RiotMingle/newrelic-client-go v0.80.0
    )
    ```
5. The example below demonstrates fetching New Relic entities.
   ```go
    ...
    import (
      ...
      "github.com/RiotMingle/newrelic-client-go/newrelic"
...
1. Run the following command to tell Go to download the latest version.
   ```
   go get github.com/RiotMingle/newrelic-client-go@latest
   ```
2. Run `go mod tidy` to sync your dependencies with your code.
3. Confirm your `go.mod` file is referencing the [latest version](https://github.com/RiotMingle/newrelic-client-go/releases/latest).
...
- [Issues or Enhancement Requests](https://github.com/RiotMingle/newrelic-client-go/issues/new/choose) - Issues and enhancement requests can be submitted in the Issues tab of this repository. Please search for and review the existing open issues before submitting a new issue.
